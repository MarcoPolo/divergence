...
(defn leveltwo [stage]
  [(e/timestream)
   ...
   (enemies/flappy 400 200 :flappy2 stage)
   (enemies/flappy 600 100 :flappy4 stage)
   (enemies/flappy2 1000 300 :flappy3 stage)
...
(defn levelthree [stage]
  [(e/timestream)
   ...
   (e/boxfloat :boxfloat1 1300 150 stage)
   ...
   (e/push-button-box-fall-block 1000 500 stage)
