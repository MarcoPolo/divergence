...
{{
var G__10435 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10435;
continue;
}
} else
...
{var pred__10439 = cljs.core._EQ_;var expr__10440 = limit;if(cljs.core.truth_(pred__10439.call(null,1,expr__10440)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10439.call(null,2,expr__10440)))
...
var G__10442 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10443 = (limit__$1 - 1);
var G__10444 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10442;
limit__$1 = G__10443;
parts = G__10444;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10446 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10446))
{var replacement_10447 = temp__4090__auto___10446;buffer.append([cljs.core.str(replacement_10447)].join(''));
} else
{buffer.append(ch);
}
{
var G__10448 = (index + 1);
index = G__10448;
continue;
}
}
